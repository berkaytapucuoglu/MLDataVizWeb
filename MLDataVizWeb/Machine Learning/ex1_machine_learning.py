...
data = pd.read_excel('../final_data/Exercise1Completex.xlsx')

X = data.iloc[:, :2]  # First two columns as independent variables
Y = data.iloc[:, -1]  # Last column as dependent variable

threshold_index1 = 10040  # Starting index of the first test set
threshold_index2 = 10440  # Starting index of the second test set
...
print("Test set size:", X_train.shape)
print("First Test set size:", X_test1.shape)
print("Second Test set size:", X_test2.shape)
