...
data = pd.read_excel('../final_data/Exercise4Completex.xlsx')

X = data.iloc[:, :2]   # First two columns as independent variables
Y = data.iloc[:, -1]   # Last column as dependent variable

threshold_index1 = 18616  # Starting index of the first test set
threshold_index2 = 21363  # Starting index of the second test set
